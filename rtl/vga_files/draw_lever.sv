...
//------------------------LEVER_6---------------------------
            ...
            begin
            if(lever_used_in[6] == 1)
                rgb_nxt = 12'h3_3_3;
            else if(lever_used_in[6] == 0) 
                rgb_nxt = 12'h6_6_6;
            end
...
//------------------------LEVER_5---------------------------
            ...
            begin
            if(lever_used_in[5] == 1)
                rgb_nxt = 12'h3_3_3;
            else if(lever_used_in[5] == 0) 
                rgb_nxt = 12'h6_6_6;
            end
...
//------------------------LEVER_4---------------------------
            ...
            begin
            if(lever_used_in[4] == 1)
                rgb_nxt = 12'h3_3_3;
            else if(lever_used_in[4] == 0) 
                rgb_nxt = 12'h6_6_6;
            end
...
//------------------------LEVER_3---------------------------
            ...
            begin
            if(lever_used_in[3] == 1)
                rgb_nxt = 12'h3_3_3;
            else if(lever_used_in[3] == 0) 
                rgb_nxt = 12'h6_6_6;
            end
...
//------------------------LEVER_2---------------------------
            ...
            begin
            if(lever_used_in[2] == 1)
                rgb_nxt = 12'h3_3_3;
            else if(lever_used_in[2] == 0) 
                rgb_nxt = 12'h6_6_6;
            end
...
//------------------------LEVER_1---------------------------
            ...
            begin
            if(lever_used_in[1] == 1)
                rgb_nxt = 12'h3_3_3;
            else if(lever_used_in[1] == 0) 
                rgb_nxt = 12'h6_6_6;
            end
...
//------------------------LEVER_0---------------------------
            ...
            begin
            if(lever_used_in[0] == 1)
                rgb_nxt = 12'h3_3_3;
            else if(lever_used_in[0] == 0) 
                rgb_nxt = 12'h6_6_6;
            end
